...
export function Footer() {
  return (
    <footer className="bg-gradient-to-b from-background to-eco-dark/10 border-t border-border/50">
      <div className="container mx-auto px-4">
        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="w-9 h-9 rounded-lg bg-eco-primary/10 flex items-center justify-center hover:bg-eco-primary/20 transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Mail className="w-4 h-4 text-eco-primary mt-0.5 flex-shrink-0" />
                <div>
                  <a
                    href="mailto:info@ficpm.org"
                    className="text-sm text-muted-foreground hover:text-eco-primary transition-colors block"
                  >
                    info@ficpm.org
                  </a>
                  <a
              ...
              <li className="flex items-start gap-3">
                <Phone className="w-4 h-4 text-eco-primary mt-0.5 flex-shrink-0" />
        ...
        <div className="py-6 border-t border-border/50">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} FICPM. All rights reserved.</p>
            <div className="flex items-center gap-6">
              <Link href="#" className="text-sm text-muted-foreground hover:text-eco-primary transition-colors">
                Privacy Policy
              </Link>
              <Link href="#" className="text-sm text-muted-foreground hover:text-eco-primary transition-colors">
                Terms of Service
